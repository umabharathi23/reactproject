...
//     function hi(){
//       {
//         window.location.assign(`/businessloanform/`)
//         }
//     }
//     return(
...
//             <h1 style={{color:'darkgreen'}}>Business Loan</h1>
//                 <br/>
...
//                 <Link to={`/businessloanform/`}><button onClick={hi} style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Apply Loan</button></Link>
//                 </form>
//             </div>
...
function Businessloan(){
    ...
    return(
        ...
        <div style={{height:'600px',width:'1400px'}}>
            ...
            <br/>
            <br/>
            <div style={{height:'600px',width:'800px',float:'left',}}><img src={c13} style={{height:'600px',width:'850px',borderRadius:'50px'}}/></div>
            <div style={{height:'600px',width:'500px',float:'left',border:'7px solid green',borderRadius:'50px',marginLeft:'90px'}}>
            <h1 style={{color:'darkviolet'}}>Business Loan</h1>
                <br/>
                
                <h4 style={{color:'darkgreen'}}> Your Business Loan Amount</h4>
                <br/>
                <form>
             ...
             <p style={{fontWeight:'bold'}}>Calculate your Interset based on your loanperiods
                ...
                <Link to={`/businesscalci1/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white',marginRight:'10px'}}>One Lakh</button></Link>
                <Link to={`/businesscalci2/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white',marginRight:'10px'}}>Five Lakhs</button></Link>
                <Link to={`/businesscalci3/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Ten Lakhs</button></Link>
                </form>
            </div>

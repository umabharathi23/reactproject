...
//                 <h1 style={{color:'darkgreen'}}>Car Loan</h1>
//                 <br/>
...
//                 {/* <button  onClick={hi} style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Apply Now</button>
//                */}
//                  <Link to={`/carloanform/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Apply Loan</button></Link>
//                 </form>
//             </div>
...
function Carloan(){
    ...
    return(
        ...
        <div style={{height:'600px',width:'1400px'}}>
            ...
            <div style={{height:'600px',width:'500px',float:'left',border:'7px solid green',borderRadius:'50px',marginLeft:'90px'}}>
            <h1 style={{color:'darkviolet'}}>Car Loan</h1>
                <br/>
             ...
             <p style={{fontWeight:'bold'}}>Calculate your Interset based on your loanperiods
                ...
                <Link to={`/carcalci1/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white',marginRight:'10px'}}>One Lakh</button></Link>
                <Link to={`/carcalci2/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white',marginRight:'10px'}}>Five Lakhs</button></Link>
                <Link to={`/carcalci3/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Ten Lakhs</button></Link>
                </form>
            </div>

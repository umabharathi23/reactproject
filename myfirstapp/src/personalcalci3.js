...
function Personalcalci3(){
    const[values,setvalue]=useState('')
    function handlesubmit(e){
         e.preventDefault()
        // console.log((parseInt(1000000)*(0.05*values))+parseInt(1000000))
    }
    ...
    return(
        ...
        <br/>
        <h1 style={{color:'red'}}>You Selected Personal Loan Amount is:10,00,000</h1><br/>

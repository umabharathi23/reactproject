...
function Personalcalci1(){
    ...
    return(
        ...
        <br/>
        <h1 style={{color:'red'}}>You Selected Personal Loan Amount is:1,00,000</h1><br/>
        ...
        <Link to={`/pfl/`}><button style={{height:'40px',width:'120px',background:'purple',borderRadius:'50px',color:'white'}}>Apply Loan</button></Link>
       
        
      
        </div>
    ) }
 export default Personalcalci1
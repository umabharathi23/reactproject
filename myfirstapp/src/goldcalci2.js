...
function Goldcalci2(){
    ...
    return(
        ...
        <br/>
        <h1 style={{color:'red'}}>You Selected Gold Loan Amount is:5,00,000</h1><br/>
        ...
        <Link to={`/goldloanform/`}><button style={{height:'40px',width:'120px',background:'purple',borderRadius:'50px',color:'white'}}>Apply Loan</button></Link>
        <br/>
        <br/>

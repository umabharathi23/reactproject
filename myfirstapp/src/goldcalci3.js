...
function Goldcalci3(){
    ...
    return(
        ...
        <br/>
        <h1 style={{color:'red'}}>You Selected Gold Loan Amount is:10,00,000</h1><br/>
        ...
        {/* <button>{(parseInt(1000000)*(0.12*values))+parseInt(1000000)}</button> */}
        ...
        <Link to={`/goldcalci1/`}><button style={{height:'40px',width:'120px',background:'',borderRadius:'0px',color:'black',marginLeft:"30px"}}>1,00,000 Loan</button></Link>
        <Link to={`/goldcalci2/`}><button style={{height:'40px',width:'120px',background:'',borderRadius:'0px',color:'black',marginLeft:"30px"}}>5,00,00 Loan</button></Link>
      
        </div>
    ) }
 export default Goldcalci3
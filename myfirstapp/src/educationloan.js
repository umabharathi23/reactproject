// import c10 from './c12.jpg';
// import {Link} from "react-router-dom"
// function Educationloan(){
//     function hi(){
       
//         {
//         window.location.assign(`/educationloanform/`)
//         }
//     }
//     return(
...
//             <h1 style={{color:'darkgreen'}}>Education Loan</h1>
//                 <br/>
...
//                 <Link to={`/educationloanform/`}><button onClick={hi} style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Apply Loan</button></Link>
//                 </form>
//             </div>
...
function Educationloan(){
    ...
    return(
        ...
        <div style={{height:'600px',width:'1400px'}}>
            ...
            <br/>
            <br/>
            <div style={{height:'600px',width:'800px',float:'left',}}><img src={c11} style={{height:'600px',width:'850px',borderRadius:'50px'}}/></div>
            <div style={{height:'600px',width:'500px',float:'left',border:'7px solid green',borderRadius:'50px',marginLeft:'90px'}}>
            <h1 style={{color:'darkviolet'}}>Education Loan</h1>
                <br/>
                
                <h4 style={{color:'darkgreen'}}> Your Education Loan Amount</h4>
                <br/>
                <form>
             ...
             <p style={{fontWeight:'bold'}}>Calculate your Interset based on your loanperiods
                ...
                <Link to={`/educationcalci1/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white',marginRight:'10px'}}>One Lakh</button></Link>
                <Link to={`/educationcalci2/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white',marginRight:'10px'}}>Five Lakhs</button></Link>
                <Link to={`/educationcalci3/`}><button style={{height:'40px',width:'120px',background:'darkgreen',borderRadius:'50px',color:'white'}}>Ten Lakhs</button></Link>
                </form>
            </div>
